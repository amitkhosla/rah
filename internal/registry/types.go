...
type RegistryNode struct {
	...
	Value        uint32 // The ID (TenantID, KeyID, or ValueID)
}
...
type TenantRegistry struct {
	...
	MaxTenants uint32 // Total capacity of the matrix
...
type GlobalState struct {
	...
	FreeSlots []uint32 // Stack of deleted TenantIDs available for reuse
}
