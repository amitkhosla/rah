...
//
//	Studio DSL export â†’ UnifiedSync â†’ Compiler â†’ Engine â†’ Execution â†’ Response
//
...
func TestPatternMatchE2ENoMatchPath(t *testing.T) {
	...
	// Absent header â†’ empty slot â†’ no-match â†’ 404.
