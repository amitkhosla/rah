	...
	return []StepDescriptor{
		{
			...
			Category:    "ai",
			Capability:  "format",
			Description: "Apply structural wire-format transformations to canonical messages when routing between LLM providers. Pure Go — no LLM calls. Each transform is independently togglable.",
